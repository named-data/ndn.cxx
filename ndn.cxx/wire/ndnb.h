...
#ifndef NDN_WIRE_NDNB_H
#define NDN_WIRE_NDNB_H
...
/**
 * @brief Class for working with ndnb encoding
 */
class Ndnb : public Base
{
public:
  /**
   ...
   */
  static void
  appendBlockHeader (std::ostream &os, size_t value, ndn_tt block_type);
  ...
  /**
   * @brief Append NDNB closer tag (size is 1)
   * @param os output stream to write
   */
  inline static void
   ...
   */
  inline static void
  appendTaggedBlob (std::ostream &os, ndn_dtag dtag, const void *data, size_t size);
   ...
   */
  inline static void
  appendTaggedBlob (std::ostream &os, ndn_dtag dtag, const Blob &blob);
   ...
   */
  inline static void
  appendTaggedNumber (std::ostream &os, ndn_dtag dtag, uint32_t number);
   ...
   */
  inline static void
  appendString (std::ostream &os, ndn_dtag dtag, const std::string &string);

  /**
   * @brief Format interest in NDNb encoding
   * @param os output stream to write
  ...
  /**
   * @brief Append exclude filter in NDNb encoding
   * @param os output stream to write
  ...
  /**
   * @brief Format data in NDNb encoding
   * @param os output stream to write
...
inline void
Ndnb::appendCloser (std::ostream &os)
{
  os.put (Ndnb::NDN_CLOSE_TAG);
}

inline void
Ndnb::appendTimestampBlob (std::ostream &os, const Time &time)
{
  appendTimestampBlob (os, time - time::UNIX_EPOCH_TIME);
}

inline void
Ndnb::appendTaggedBlob (std::ostream &os, Ndnb::ndn_dtag dtag, const void *data, size_t size)
{
  appendBlockHeader (os, dtag, Ndnb::NDN_DTAG);
  /* 2 */
  if (size>0)
    {
      appendBlockHeader (os, size, Ndnb::NDN_BLOB);
...
inline void
Ndnb::appendTaggedBlob (std::ostream &os, ndn_dtag dtag, const Blob &blob)
{
  appendTaggedBlob (os, dtag, blob.buf (), blob.size ());
}

inline void
Ndnb::appendTaggedNumber (std::ostream &os, Ndnb::ndn_dtag dtag, uint32_t number)
{
  appendBlockHeader (os, dtag, Ndnb::NDN_DTAG);
  {
...
inline void
Ndnb::appendString (std::ostream &os, Ndnb::ndn_dtag dtag, const std::string &string)
{
  appendBlockHeader (os, dtag, Ndnb::NDN_DTAG);
  {
    appendBlockHeader (os, string.size (), Ndnb::NDN_UDATA);
