...
template<class T>
inline size_t
Ccnb::AppendTaggedBlob (OutputIterator &start, uint32_t dtag, const T &data)
{
...
template<class T>
inline size_t
Ccnb::AppendTaggedBlobWithPadding (OutputIterator &start, uint32_t dtag, uint32_t length, const T &data)
{
